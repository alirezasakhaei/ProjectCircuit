            ...
            for (int j = (i+1);j<nodes.size();j++){
                ...
                if (parralles > 0){
                    if (nodes.get(i).getEarthConnections() > 0)
                        g.drawLine(50 + 100*(i-1) , 450, 50 + 100*(i-1), 450 - 50*(j-i));
                    else
                        g.drawLine(50 + 100*(i-1) , 400, 50 + 100*(i-1), 450 - 50*(j-i));
                    if (nodes.get(j).getEarthConnections() > 0)
                        g.drawLine(50 + 100*(j-1) , 450, 50 + 100*(j-1), 450 - 50*(j-i));
                    else
                        g.drawLine(50 + 100*(j-1) , 400, 50 + 100*(j-1), 450 - 50*(j-i));
