...
public class ElementShapePro extends JPanel {
    ...
    public void paint(Graphics g) {
        if (!isHorizental && isUpWardRightWard){
            setSize(verticalElementWidth,verticalElementHeight);
            x = verticalElementWidth;
            y = verticalElementHeight;
            g.drawLine(x/2,0,x/2,y/4);
        ...
        if (isHorizental && isUpWardRightWard){
            setSize(horizentalElementWidth,horizentalElementHeight);
            g.drawLine(25,5,0,5);
    ...
    public static void setHorizentalElementWidth(int horizentalElementWidth) {
        ElementShapePro.horizentalElementWidth = horizentalElementWidth;
    }

    public static void setHorizentalElementHeight(int horizentalElementHeight) {
        ElementShapePro.horizentalElementHeight = horizentalElementHeight;
    }

    public static void setVerticalElementWidth(int verticalElementWidth) {
        ElementShapePro.verticalElementWidth = verticalElementWidth;
    }

    public static void setVerticalElementHeight(int verticalElementHeight) {
        ElementShapePro.verticalElementHeight = verticalElementHeight;
    }
}
